  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        <h1 className="font-serif text-4xl md:text-5xl mb-4">{privacy.title}</h1>
        <p className="text-muted-foreground text-sm mb-14">{privacy.effectiveDate}</p>

        <div className="space-y-10">
          {privacy.sections.map((section: { heading: string; body: string }) => (

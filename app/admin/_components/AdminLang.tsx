...
const DICT = {
  en: {
    ...
    settingsIntro: 'Booking availability, review moderation, and how clients reach you.',
    notifications: 'Notifications',
    notificationsHint: 'Where new contact messages and booking requests are emailed.',
    notificationEmail: 'Notification email',
    notificationEmailHint: 'Alerts from the contact form and bookings go here.',
    bookingAvailability: 'Booking availability',
    bookingAvailabilityHint: 'The hours and days offered in the website’s booking calendar.',
    opensAt: 'Opens at',
    closesAt: 'Closes at',
    openDays: 'Open days',
    openDaysHint: 'Days clients can pick in the calendar.',
    reviewsSection: 'Reviews',
    reviewsSectionHint: 'Choose whether new reviews go live instantly or wait for your approval.',
    ...
    feature: 'Feature',
    featured: 'Featured',
    featuredMaxReached: '✗ You can feature up to 6 reviews.',
  ...
  uk: {
    ...
    settingsIntro: 'Доступність запису, модерація відгуків і як клієнти з вами звʼязуються.',
    notifications: 'Сповіщення',
    notificationsHint: 'Куди надсилати нові повідомлення з форми та запити на запис.',
    notificationEmail: 'Email для сповіщень',
    notificationEmailHint: 'Сюди надходять сповіщення з форми контактів та записів.',
    bookingAvailability: 'Доступність запису',
    bookingAvailabilityHint: 'Години та дні, доступні в календарі запису на сайті.',
    opensAt: 'Відкриття о',
    closesAt: 'Закриття о',
    openDays: 'Робочі дні',
    openDaysHint: 'Дні, які клієнти можуть обрати в календарі.',
    reviewsSection: 'Відгуки',
    reviewsSectionHint: 'Оберіть, чи зʼявляються нові відгуки одразу, чи після вашого схвалення.',

...
export const t = {
  en: {
    ...
    booking: {
      ...
      detailsPlaceholder: 'Preferred days/times, or describe what you’re looking for',
      detailsLabelOther: 'What would you like?',
      detailsPlaceholderOther: 'Tell us what you’re looking for — plus any preferred days/times',
      send: 'Send Text',
      cancel: 'Cancel',
  ...
  uk: {
    ...
    booking: {
      ...
      detailsPlaceholder: 'Зручні дні/час або опишіть, що вас цікавить',
      detailsLabelOther: 'Що бажаєте?',
      detailsPlaceholderOther: 'Опишіть, що вас цікавить, — і зручні дні/час',
      send: 'Надіслати',
      cancel: 'Скасувати',
  ...
  es: {
    ...
    booking: {
      ...
      detailsPlaceholder: 'Días/horas preferidos, o describe lo que buscas',
      detailsLabelOther: '¿Qué te gustaría?',
      detailsPlaceholderOther: 'Cuéntanos qué buscas — y días/horas preferidos',
      send: 'Enviar Mensaje',
      cancel: 'Cancelar',

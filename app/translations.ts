...
export const t = {
  en: {
    ...
    reviews: {
      ...
      photoLabel: 'Photos',
      photoHint: 'Optional · share photos of your service or experience',
      ...
      reviewRequired: 'Please write a few words',
      reviewTooShort: 'Please write at least 10 characters',
      reviewTooLong: 'Reviews are limited to 1000 characters',
      ratingRequired: 'Please select a star rating',
      imageTooMany: 'You can add up to 4 photos',
      imageBadType: 'Only JPEG, PNG, or WebP images are allowed',
    ...
    booking: {
      ...
      phonePlaceholder: '(585) 555-0123',
      emailLabel: 'Email (optional)',
      emailPlaceholder: 'you@example.com',
      contactMethodLabel: 'How should Yanina reply?',
      methodSms: 'Text message',
      methodInstagram: 'Instagram DM',
      methodEmail: 'Email',
      ...
      receivedDuplicate: 'We already had this request, so there’s no need to send it again.',
      ...
      closeCta: 'Close',
      phoneRequired: 'Please enter your phone number so Yanina can text you back.',
      phoneInvalid: 'That phone number doesn’t look right.',
      emailRequired: 'Please enter your email address.',
      emailInvalid: 'That email address doesn’t look right.',
      rateLimited: 'Too many requests from this device. Please try again later or text us directly.',
      serverError: 'Something went wrong. Please try again or text us directly.',
      noSlots: 'No times available on this day.',
      noticeNote: 'Appointments need at least {n} hours’ notice.',
      preferredOptional: 'Optional. You can also just describe what works for you.',
    },
  ...
  uk: {
    ...
    reviews: {
      ...
      photoLabel: 'Фото',
      photoHint: 'Необов\'язково · додайте фото вашої послуги чи досвіду',
      photoUpload: '+ Додати фото',
      ...
      sortMostRelevant: 'Найрелевантніші',
      sortNewest: 'Нові',
      sortOldest: 'Старі',
      ...
      nameTooLong: 'Ім\'я має містити не більше 60 символів',
      reviewRequired: 'Будь ласка, напишіть кілька слів',
      reviewTooShort: 'Напишіть щонайменше 10 символів',
      reviewTooLong: 'Відгуки обмежені 1000 символами',
      ratingRequired: 'Будь ласка, оберіть оцінку',
      imageTooMany: 'Можна додати до 4 фото',
      imageBadType: 'Дозволені лише зображення JPEG, PNG або WebP',
      imageTooLarge: 'Кожне зображення має бути не більше 5 МБ',
    ...
    booking: {
      ...
      dateTimeLabel: 'Бажані дата й час',
      dateTimePlaceholder: 'Оберіть дату й час…',
      ...
      emailPlaceholder: 'you@example.com',
      contactMethodLabel: 'Як Яніні відповісти?',
      methodSms: 'SMS',
      ...
      closeCta: 'Закрити',
      phoneRequired: 'Вкажіть номер телефону, щоб Яніна могла вам відповісти.',
      phoneInvalid: 'Номер телефону виглядає некоректно.',
      emailRequired: 'Вкажіть вашу електронну адресу.',
      emailInvalid: 'Електронна адреса виглядає некоректно.',
      rateLimited: 'Забагато запитів із цього пристрою. Спробуйте пізніше або напишіть нам напряму.',
      serverError: 'Щось пішло не так. Спробуйте ще раз або напишіть нам напряму.',
      noSlots: 'На цей день немає вільного часу.',
      noticeNote: 'Записуватися потрібно щонайменше за {n} год.',
      preferredOptional: 'Необов’язково. Можна просто описати, який час вам зручний.',
    },
  ...
  es: {
    ...
    reviews: {
      ...
      photoLabel: 'Fotos',
      photoHint: 'Opcional · comparte fotos de tu servicio o experiencia',
      photoUpload: '+ Añadir fotos',
      ...
      sortMostRelevant: 'Más relevantes',
      sortNewest: 'Más recientes',
      sortOldest: 'Más antiguas',
      sortHighest: 'Mejor calificación',
      sortLowest: 'Peor calificación',
      helpful: 'Útil',
      readMore: 'Leer más',
      ...
      reviewRequired: 'Por favor, escribe unas palabras',
      reviewTooShort: 'Escribe al menos 10 caracteres',
      reviewTooLong: 'Las reseñas están limitadas a 1000 caracteres',
      ratingRequired: 'Por favor, selecciona una calificación',
      imageTooMany: 'Puedes añadir hasta 4 fotos',
      imageBadType: 'Solo se permiten imágenes JPEG, PNG o WebP',
      imageTooLarge: 'Cada imagen debe pesar 5 MB o menos',
    ...
    booking: {
      ...
      dateTimeLabel: 'Fecha y hora preferidas',
      dateTimePlaceholder: 'Selecciona fecha y hora…',
      ...
      contactMethodLabel: '¿Cómo te responde Yanina?',
      methodSms: 'Mensaje de texto',
      methodInstagram: 'DM de Instagram',
      methodEmail: 'Email',
      methodCall: 'Llamada',
      ...
      closeCta: 'Cerrar',
      phoneRequired: 'Ingresa tu número de teléfono para que Yanina pueda responderte.',
      phoneInvalid: 'Ese número de teléfono no parece correcto.',
      emailRequired: 'Ingresa tu correo electrónico.',
      emailInvalid: 'Ese correo electrónico no parece correcto.',
      rateLimited: 'Demasiadas solicitudes desde este dispositivo. Inténtalo más tarde o escríbenos directamente.',
      serverError: 'Algo salió mal. Inténtalo de nuevo o escríbenos directamente.',
      noSlots: 'No hay horarios disponibles ese día.',
      noticeNote: 'Las citas requieren al menos {n} horas de anticipación.',
      preferredOptional: 'Opcional. También puedes describir qué horario te conviene.',
    },
